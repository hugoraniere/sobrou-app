...
const processChartData = (incomes: Transaction[]) => {
...
const IncomeByTypeChart: React.FC<IncomeByTypeChartProps> = ({ 
  ...
  const { filteredTransactions } = usePeriodFilter(incomes, selectedPeriod);
    ...
    <div className="h-full w-full flex flex-col">
      ...
      {topCategory && (
        <div className="mb-4 p-3 bg-gray-50 rounded-md text-sm">
          <p>
            <span className="font-medium">{topCategory.percentage.toFixed(1)}%</span> das suas receitas vieram de{' '}
