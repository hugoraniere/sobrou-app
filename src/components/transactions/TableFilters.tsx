              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Select value={filters.category} onValueChange={value => onFilterChange('category', value)}>
                      ...
                      <SelectContent className="max-h-[300px]">
                        ...
                        {transactionCategories.map(category => <SelectItem key={category.id} value={category.id}>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" placeholder="Min" value={filters.minAmount} onChange={e => onFilterChange('minAmount', e.target.value)} className="w-1/2" />
                      <span className="text-gray-500">até</span>
                      <Input type="number" placeholder="Max" value={filters.maxAmount} onChange={e => onFilterChange('maxAmount', e.target.value)} className="w-1/2" />
                    </div>
                  </div>
                </div>
