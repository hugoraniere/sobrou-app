...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="w-full min-h-screen py-12 bg-green-50/30 overflow-x-visible flex items-center justify-center">
      <div className="h-full grid grid-cols-1 lg:grid-cols-2 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 items-center">
        {/* Div 1 - Conteúdo */}
        ...
        <div className="flex items-center justify-start h-full">
          <img 
            ...
            className="w-full lg:w-[120%] max-w-none h-auto max-h-full object-contain object-left shadow-2xl" 
            loading="eager" 
            fetchPriority="high" 
            decoding="async" 
          />
