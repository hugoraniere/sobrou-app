    ...
    <section id="hero" className="relative w-full lg:h-[calc(100vh-64px)]">
      ...
      <div className="hidden lg:block lg:absolute top-16 bottom-8 right-0 w-[47%] z-0 pointer-events-none">
        <img
          ...
          className="w-full h-full object-cover object-left shadow-2xl rounded-l-2xl"
          loading="eager"
          fetchPriority="high"
          decoding="async"
          aria-hidden="true"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch min-h-[80vh] lg:h-full">
          ...
          <div className="flex flex-col justify-center text-center lg:text-left lg:basis-1/2 py-16 lg:py-0 lg:pr-6">
            <h1 className="font-outfit text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
              Organize suas finanças,<br />
              é só digitar
            </h1>
            <p className="font-outfit text-xl text-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0 lg:max-w-none">
