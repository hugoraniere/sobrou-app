...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="w-full h-[85vh] bg-green-50/30 overflow-hidden">
      <div className="h-full grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center lg:justify-start">
          <img 
            ...
            className="w-full lg:w-[120%] h-auto lg:h-full object-cover object-left shadow-2xl rounded-l-2xl lg:rounded-l-none" 
            loading="eager" 
            fetchPriority="high" 
            decoding="async" 
          />
