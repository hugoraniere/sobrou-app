...
DROP FUNCTION IF EXISTS public.get_public_blog_posts(text, integer, integer);
DROP FUNCTION IF EXISTS public.get_public_blog_post(uuid);

-- Recreate get_public_blog_posts function with slug
...
-- Recreate get_public_blog_post function with slug
